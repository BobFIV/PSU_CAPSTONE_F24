...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COAP_SERVER_HOSTNAME, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COAP_SERVER_PORT, 5683);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COAP_TX_RESOURCE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COAP_RX_RESOURCE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_LOAD_SIZE, 0x35000);
